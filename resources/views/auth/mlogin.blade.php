                ...
                <div class="py-md-5">
                    ...
                    <form method="POST" class="appointment-form ftco-animate" action="{{ route('login') }}">
                        ...
                        <div class="card-body text-center">
                         ...
                         <div class="row">
                             <div class="col-5">
                            <label class="col-sm-4 col-form-label-f text-black"> <strong> {{ __('نام کاربری') }} </strong> </label>
                             </div>
                             <div class="col-5">
                        <div class="d-md-flex">
                         ...
                         <div class="row">
                             <div class="col-5">
                              <label class="col-sm-4 col-form-label-f text-black"> <strong> {{ __('رمز عبور') }} </strong> </label>
                             </div>
                         <div class="col-5">
                          <div class="d-md-flex">
                            <div class="form-group">
