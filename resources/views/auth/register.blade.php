            ...
            <div class="col-md-4 py-2 px-md-7">
                <div class="py-md-5">
                    ...
                    <form method="post" class="appointment-form ftco-animate" action="{{ route('register') }}" >
                        ...
                        <div class="row">
                        <label class="col-sm-3 col-form-label-f text-white"> <strong> {{ __('نام') }} </strong> </label>
                        ...
                        <div class="row">
                        <label class="col-sm-3 col-form-label-f text-white"> <strong> {{ __('فامیل') }} </strong> </label>
                        <div class="d-md-flex-r text-black">
                            <div class="form-group">
                        ...
                        <div class="row">
                         <label class="col-sm-3 col-form-label-f text-white"> <strong> {{ __('سن') }} </strong> </label>
                        <div class="d-md-flex-r text-black">
                            <div class="form-group">
                        ...
                        <div class="row">
                        <label class="col-sm-3 col-form-label-f text-white"> <strong> {{ __('نام کاربری') }} </strong> </label>
                        <div class="d-md-flex-r text-black">
                            <div class="form-group">
                        ...
                        <div class="row">
                        <label class="col-sm-3 col-form-label-f text-white"> <strong> {{ __('موبایل') }} </strong> </label>
                        <div class="d-md-flex-r text-black">
                            <div class="form-group">
                        ...
                        <div class="row">
                        <label class="col-sm-3 col-form-label-f text-white"> <strong> {{ __('کد معرف') }} </strong> </label>
                        <div class="d-md-flex-r text-black">
                            <div class="form-group">
...
{{--                                        <strong>{{ 'توکن وارد شده اشتباه هست' }}</strong>--}}
                        ...
                        <div class="row">
                        <label class="col-sm-3 col-form-label-f text-white"> <strong> {{ __('رمز عبور') }} </strong> </label>
                        <div class="d-md-flex-r text-black">
                            <div class="form-group">
                        ...
                        <div class="row">
                        <label class="col-sm-3 col-form-label-f text-white"> <strong> {{ __('تکرار رمز') }} </strong> </label>
                        <div class="d-md-flex-r text-black">
                            <div class="form-group">
