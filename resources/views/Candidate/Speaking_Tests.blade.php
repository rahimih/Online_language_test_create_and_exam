@extends('layouts.C_app', ['activePage' => 'Speaking Test', 'titlePage' => __('آزمون SPEAKING')])
@section('content')
    <div class="content">
                            ...
                            <div class="card card-chart text-left">
                                ...
                                <div class="card-body text-center">
                                        ...
                                        <div class="card-actions">
                                            <a  rel="tooltip"  class="btn btn-success btn-link" href="{{action('OtTestUserStartController@SpeakingConfirm',[$test_registers['TEST_REGISTER_ID'],$test_registers['TESTS_ID']])}}" title="شروع آزمون">
                                         <i class="material-icons">edit</i>
                                            </a>
                                        </div>

                                    <a href="{{action('OtTestUserStartController@SpeakingConfirm',[$test_registers['TEST_REGISTER_ID'],$test_registers['TESTS_ID']])}}" class="btn btn-round btn-info">START</a>
