...
<div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-7">
                    <form method="post" id="regForm" action="{{route('Test_Start.speaking_store') }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('POST')
                            ...
                            <div class="row">
                                <div class="card ">
                                    ...
                                    <div class="card-body ">
                                        ...
                                        <div class="row">
                                            <div id="controls">
                                                <button type="button" onclick="startRecording"  class="btn btn-primary btn-round" id="recordButton">Record</button>
                                                <button type="button" onclick="pauseRecording" class="btn btn-primary btn-round" hidden="true" id="pauseButton">Pause</button>
                                                <button type="button" onclick="stopRecording"  class="btn btn-primary btn-round" id="stopButton">Stop</button>
                                            </div>
                                        </div>
                                        <hr>
...
<script>
    ...
    recordingsLists = document.getElementById("recordingsLists");
