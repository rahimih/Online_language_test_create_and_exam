                                ...
                                <div class="col-md-5 ml-auto mr-auto">
                                    <div class="card card-chart text-left">
                                        <div class="card-header card-header-danger text-center" data-header-animation="true">
                                            ...
                                            <h4 class="category">{{$test_defines->TYPE}} /  {{$test_defines->SUBGROUP_TEST_NAME}}</h4>
                                            <h4 class="category">{{$test_defines->TESTS_NAME}}</h4>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="text-info text-left">
                                                        @if(($test_defines->Writing_corrections_part1)>0)
                                                           Task 1 : {!!$test_defines->Writing_corrections_part1!!}  /
                                                        @endif
                                                        @if(($test_defines->Writing_corrections_part2)>0)
                                                           Task 2 : {!!$test_defines->Writing_corrections_part2!!}
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
