...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ config('app.name', 'ONLINE LANGUAGE TESTS') }}</title>
...
{{--    <link rel="stylesheet" href="public/css/font-awesome.min.css">--}}
    ...
    <link href="{{ asset('material') }}/css/material-dashboard-rtl.css?v=2.1.1" rel="stylesheet" />
    ...
    <body class="{{ $class ?? '' }}">
        @auth()
            ...
            @include('layouts.page_templates.e_auth')
        @endauth
        @guest()
            @include('layouts.page_templates.e_guest')
        @endguest
                ...
                <li class="adjustments-line">
                    <a href="javascript:void(0)" class="switch-trigger background-color">
                        <div class="badge-colors ml-auto mr-auto">
                            ...
                            <span class="badge filter badge-rose" data-background-color="red"></span>
                        </div>
                        <div class="clearfix"></div>
                    </a>
                </li>
